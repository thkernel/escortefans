...
class LanguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create langue" do
    assert_difference('Langue.count') do
      post langues_url, params: { langue: { name: @langue.name, uid: @langue.uid, user_id: @langue.user_id } }
    end
  ...
  test "should update langue" do
    patch langue_url(@langue), params: { langue: { name: @langue.name, uid: @langue.uid, user_id: @langue.user_id } }
