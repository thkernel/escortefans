...
class SocialMediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social_medium" do
    assert_difference('SocialMedium.count') do
      post social_media_url, params: { social_medium: { name: @social_medium.name, uid: @social_medium.uid, url: @social_medium.url, user_id: @social_medium.user_id } }
    end
  ...
  test "should update social_medium" do
    patch social_medium_url(@social_medium), params: { social_medium: { name: @social_medium.name, uid: @social_medium.uid, url: @social_medium.url, user_id: @social_medium.user_id } }
